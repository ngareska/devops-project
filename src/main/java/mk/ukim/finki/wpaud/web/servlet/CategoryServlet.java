...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("</ul>");
        out.println("<h3>Add Category info</h3>");
        out.print("<form method = 'POST' action = '/servlet/category'>");
        out.print("<label for = 'name'> Name: </label>");
        out.print("<input id = 'name' type = 'text' name = 'name'/>");
        out.print("<label for = 'desc'> Description: </label>");
        out.print("<input id = 'desc' type = 'text' name = 'desc'/>");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        categoryService.create(categoryName, categoryDescription); //nova kategorija so ime i opis
